...
TNode *Parser::parse(const string &s) {
  try {
	...
	TNode *ast = nullptr;
	switch (parseOption) {
	  case Option::program:ast = eatProgram();
		break;
	  case Option::procedure:ast = eatProcedure();
		break;
	  case Option::stmt:ast = eatStmt();
		break;
	  case Option::readStmt:ast = eatStmtRead();
		break;
	  case Option::printStmt:ast = eatStmtPrint();
		break;
	  case Option::callStmt:ast = eatStmtCall();
		break;
	  case Option::whileStmt:ast = eatStmtWhile();
		break;
	  case Option::ifStmt:ast = eatStmtIf();
		break;
	  case Option::assignStmt:ast = eatStmtAssign();
		break;
	  case Option::condExpr:ast = eatCondExpr();
		break;
	  case Option::expr:ast = eatExpr();
		break;
	  case Option::term:ast = eatTerm();
		break;
	  case Option::name:
	  case Option::constant:ast = eatFactor();
		break;
