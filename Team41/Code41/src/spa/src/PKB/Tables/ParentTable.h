...
public:
    ...
    getAllChildrenOf(string parentStmt);// Gets the set of stmts that are direct children of parentStmt
    ...
    unordered_set<string>
    getAllDescendantsOf(string parentStmt); // Gets the set of stmts that are descendants of parentStmt
